...
<div class="container">
	...
	<div class="span-12 last">	
		<form:form modelAttribute="accountBook" method="post">
		  	<fieldset>		
				...
				<p>
					<form:label	for="type" path="type" cssErrorClass="error">Type</form:label>
					<form:select path="type">
						<form:option value="in" label="In"></form:option>
						<form:option value="out" label="Out"></form:option>
					</form:select>
				</p>
				<p>	
					<input type="submit" />
